...
<head>
	...
	<title>Requests For Pickup</title>
	<style>
...
<body>
		...
		<div class="main-panel pr-0">
			...
			<nav aria-label="breadcrumb" >
				<ol class="breadcrumb mx-2" style="background: none;">
					...
					<li class="breadcrumb-item text-success" aria-current="page" style="color: black; font-size: 20px; font-weight: 700;">For Pickup Requests</li>
				</ol>
			</nav>
			<!---Loader--->
			...
			<div class="row justify-content-center mb-5">
				<div class="col-11">
					<table class="table table-bordered" cellspacing="0" width="100%" id="forpickup-table">
	...
	<div class="position-fixed top-0 right-0 p-3" style="z-index: 999; right: 0; top: 0;">
		<div id="success-process" class="toast hide" role="alert" aria-live="assertive" aria-atomic="true" data-delay="1600">
		    <div class="toast-body" style="background-color: rgb(69, 176, 111); box-shadow: 6px 4px 7px 0px rgba(0,0,0,0.75);">
		    	<p id="confirm-text" class="text-white ml-1 my-1" style="font-size: 17px; font-weight: 600; margin-right: 60px;">Request Completed</p>
		    </div>
		</div>
	</div>

	<!---Modal for confirm complete request--->
	<div class="modal show modal fade" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false" id="modal-complete-confirm">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-body" style="background-color: rgb(69, 176, 111);">
					<!---Image container--->
					<div class="icon-box">
						<h5 class="text-center text-white mt-2">Are you sure you want to complete this request?</h5>
					</div>
					<div class="row mt-4 justify-content-center">
						<div class="col-4 px-1">
							<button class="btn btn-outline-light btn-sm form-control" id="no-btn" type="button" data-dismiss="modal" data-target="#modal-complete-confirm" style="font-weight: 500;">No</button>
						</div>
						<div class="col-4 px-1">
							<button class="btn btn-light btn-sm form-control" id="complete-btn" type="button" style="font-weight: 500;">Yes</button>
						</div>
					</div>
				</div>
			</div>
	...
	<script type='text/javascript' src="js/requestforpickup.js"></script>
